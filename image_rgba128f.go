...
func (p *RGBA128f) ColorModel() color.Model { return colorRGBA128fModel }
...
func (p *RGBA128f) RGBA128fAt(x, y int) colorRGBA128f {
...
func (p *RGBA128f) SetRGBA128f(x, y int, c colorRGBA128f) {
	if !(image.Point{x, y}.In(p.M.Rect)) {
		return
	}
	i := p.PixOffset(x, y)
